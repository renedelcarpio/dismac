        ...
        <div className='goods-container'>
            ...
            <div className='goods__image-container'>
                <div className='goods-image'>
                    <img loading='lazy' className='refrigerator image' src={ Refri } alt="Refrigerador"/>
                    <h3 className='image-name'>Refrigeradores</h3>
                </div>
                <div className='goods-image'>
                    <img loading='lazy' className='stove image' src={ Stove } alt="Cocina"/>
                    <h3 className='image-name'>Cocinas</h3>
                </div>
                <div className='goods-image'>
                    <img loading='lazy' className='campana image' src={ Campana } alt="Campana"/>
                    <h3 className='image-name'>Campanas</h3>
                </div>
                <div className='goods-image'>
                    <img loading='lazy' className='wash image' src={ Wash } alt="Lavadora"/>
                    <h3 className='image-name'>Lavadoras</h3>
                </div>
                <div className='goods-image'>
                    <img loading='lazy' className='freezer image' src={ Freezer } alt="Freezer"/>
